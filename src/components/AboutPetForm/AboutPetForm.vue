...
<script>
import TabsForm from "@/components/Tabs/TabsForm/TabsForm";
import TabsFormItem from "@/components/Tabs/TabsForm/TabsFormItem/TabsFormItem";
...
export default {
  name: "AboutPetForm",
  components: {FileInput, PetForm, TabsFormItem, TabsForm}
}
</script>
